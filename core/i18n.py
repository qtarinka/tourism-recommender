...
STRINGS = {
    ...
    "admin_users_header": {"pl": "Użytkownicy", "en": "Users"},
    "admin_users_created": {"pl": "Utworzono", "en": "Created"},
    "admin_users_favorites": {"pl": "Ulubione", "en": "Favorites"},
    "admin_users_last_login": {"pl": "Ostatnie logowanie", "en": "Last login"},
    "admin_users_never_logged_in": {"pl": "Nigdy", "en": "Never"},
    "admin_users_status_active": {"pl": "✅ Aktywny", "en": "✅ Active"},
    "admin_users_status_blocked": {"pl": "🔒 Zablokowany", "en": "🔒 Blocked"},
    "admin_users_block_btn": {"pl": "Zablokuj", "en": "Block"},
    "admin_users_unblock_btn": {"pl": "Odblokuj", "en": "Unblock"},
    "admin_users_edit_expander": {"pl": "✏️ Edytuj dane", "en": "✏️ Edit details"},
    "admin_users_blocked_note": {
        "pl": "Zablokowani użytkownicy nie mogą się zalogować, dopóki nie zostaną odblokowani.",
        "en": "Blocked users cannot log in until unblocked.",
    },
    "admin_login_log_header": {"pl": "Dziennik logowań", "en": "Login log"},
    "admin_login_log_empty": {"pl": "Brak zarejestrowanych logowań.", "en": "No logins recorded yet."},
    ...
    "account_register_success": {
        "pl": "Konto utworzone! Zaloguj się poniżej swoją nową nazwą użytkownika i hasłem.",
        "en": "Account created! Log in below with your new username and password.",
    },
    "account_register_error": {"pl": "Nie udało się utworzyć konta: {error}", "en": "Couldn't create the account: {error}"},
    "account_admin_code_label": {"pl": "Kod administratora (opcjonalnie)", "en": "Admin code (optional)"},
    "account_admin_granted": {
        "pl": "Konto utworzone z uprawnieniami administratora! Zaloguj się poniżej.",
        "en": "Account created with admin privileges! Log in below.",
    },
    "account_blocked_message": {
        "pl": "Twoje konto zostało zablokowane. Skontaktuj się z administratorem.",
        "en": "Your account has been blocked. Contact an administrator.",
    },
